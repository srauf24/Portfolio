...
import { _copyAndTruncateStrings, each, eachArray, extend, registerEvent, safewrapClass, isCrossDomainCookie, } from './utils';
...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._onRemoteConfig = function (config) {
        ...
        (_f = this.surveys) === null || _f === void 0 ? void 0 : _f.onRemoteConfig(config);
